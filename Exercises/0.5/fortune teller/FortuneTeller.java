    ...
    implements ActionListener
{
  ...
  String fortunes[] = {"Nothing is real","Charles is a conspiracy","Aidan has 9 eyes","Deven is green"};
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    String randomFortune = fortunes[(int)(Math.random() * 4)];

    display.setText("  " + randomFortune );
    ding.play();
  }
